...
- [X] create `help/roadmap.py` to parse task files
        - state is properly calculated
        - sort available before in progress before planned, then alphabetical
- [X] generate the markdown document from the roadmap data
- [X] integrate into `sync_docs`, making that an automatic part of deployment
